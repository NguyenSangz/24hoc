...
*   **Bảo vệ toàn vẹn tài sản người dùng:** Điều chỉnh cơ chế bọc gói IndexedDB nhãn nhạy cảm bao gồm thông tin chi tiết bảng xếp hạng lịch sử và kho đồ, đồng bộ tối ưu hóa không gây mất xu tích lũy.

---

## [Phiên bản v1.9.0] - 2026-06-07

### 1. Nâng cấp bộ Nhận diện Trạng thái Hệ thống đa chủ đề (Unified State & Contrast Harmony)
*   **Dấu Kiểm điểm danh Ngày Học (Attendance Checkmarks):** Bản vẽ dấu tích hoàn thành `✓` trước đây sở hữu màu trắng tĩnh (`text-white`), lỗi tàng hình khi lướt qua giao diện nền sáng (vốn có màu nút `bg-primary` chuyển trắng ở chế độ Tối). Đã bổ sung biến ngữ cảnh đồng bộ `text-primary-text` giúp hiển thị sắc nét tự thích ứng theo cả hai chủ đề.
*   **Trú ẩn Bản dịch Flashcard:** Tối ưu hóa lớp kiểu văn bản mặt sau thẻ từ cấu trúc cứng nhắc `text-white/60 dark:text-black/60` thành hệ thừa kế tự động `text-primary-text opacity-70` bảo toàn độ tương thích với độ tương phản hệ thống, dễ dàng đọc nội dung chi tiết bài học ở chế độ sáng tối tương hỗ.

---

## [Phiên bản v1.8.5] - 2026-06-06
